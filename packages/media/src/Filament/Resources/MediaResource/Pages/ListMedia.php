        ...
        return [
            ...
            Actions\Action::make('duplicates')
                ...
                ->modalContent(function () {
                    ...
                    return view('media::filament.components.media-duplicates', compact('duplicates'));
                })
            ...
            Actions\Action::make('report')
                ...
                ->modalContent(function () {
                    ...
                    return view('media::filament.components.media-report', compact('report'));
                })
                ->modalSubmitAction(false)
                ->modalCancelActionLabel('Schließen'),
            ...
            Actions\Action::make('statistics')
                ...
                ->modalContent(function () {
                    ...
                    return view('media::filament.components.media-statistics', [
