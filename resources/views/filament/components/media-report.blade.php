    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="rounded-lg border border-gray-200 bg-gradient-to-br from-primary-50 to-primary-100 p-4 dark:border-gray-700 dark:from-primary-900 dark:to-primary-800">
            ...
            <p class="mt-1 text-sm text-primary-700 dark:text-primary-300">
                {{ App\Filament\Resources\Media\MediaResource::formatBytes($report['total']['size']) }}
            </p>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 bg-gradient-to-br from-red-50 to-red-100 p-4 dark:border-gray-700 dark:from-red-900 dark:to-red-800">
            ...
            <p class="mt-1 text-sm text-red-700 dark:text-red-300">
                {{ App\Filament\Resources\Media\MediaResource::formatBytes($report['unused']['size']) }}
            </p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div class="rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ App\Filament\Resources\Media\MediaResource::formatBytes($report['by_type']['images']['size']) }}
                </p>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ App\Filament\Resources\Media\MediaResource::formatBytes($report['by_type']['videos']['size']) }}
                </p>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ App\Filament\Resources\Media\MediaResource::formatBytes($report['by_type']['documents']['size']) }}
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="flex items-center justify-between rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ $data['count'] }} Dateien • {{ App\Filament\Resources\Media\MediaResource::formatBytes($data['size']) }}
                        </p>
                    </div>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            @if($report['largest'])
                <div class="rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ App\Filament\Resources\Media\MediaResource::formatBytes($report['largest']->size) }}
                    </p>
                </div>
            @endif
        </div>
