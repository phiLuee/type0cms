        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">{{ App\Filament\Resources\Media\MediaResource::formatBytes($totalSize) }}</p>
                </div>
        ...
        <div class="rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-950">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ App\Filament\Resources\Media\MediaResource::formatBytes($unusedSize) }}</p>
                </div>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                        <p>
                            Sie haben {{ $unusedCount }} ungenutzte Medien, die {{ App\Filament\Resources\Media\MediaResource::formatBytes($unusedSize) }} Speicherplatz belegen.
